<template>
<v-row>
  <v-col v-for="(monster, index) in monsterDirectory" :key="monster.name" cols="12" md="6">
    ...
    rounded>
      ...
      <span>
        <v-row class="d-flex justify-space-between">
          <v-col>
            <v-img :class="monster.currentLevel > 0 ? '' : 'shadow'" min-width="200px" :src="getMonsterImage(monster)"/>
          </v-col>
          <v-col>
